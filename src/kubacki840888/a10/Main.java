...
public class Main {
    ...
    static String name = "doc/a10-3.png";

    static final Mat4 IDENTITY = Mat4.identity;
    static final Mat4 SCALE = Mat4.translate(2, 2, 2);
    ...
    static Kamera kamera = new Kamera(Kamera.WIDTH, Kamera.HEIGHT, Math.PI / 2, SCALE);
...
//    static LambertMaterial augenBlue = new LambertMaterial(new Vec3(21.0 / 255, 42.0 / 255, 91.0 / 255));
    ...
    private static void listeAusfuellen(int anzahlKirbies, double abstandx) {
        lights.add(new PointLight(new Vec3(30, 35, -12), new Vec3(50, 50, 50)));
        //spiegel = new Shape[1];
...
//
    ...
    public static void main(String[] args) throws IOException {
        ...
        Group gruppe = new Group(shapes, new Transform(IDENTITY), lights);
