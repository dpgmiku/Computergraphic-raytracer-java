...
public class Kamera {
    ...
    public Ray generateRay(double x, double y) {
        ...
        return new Ray(transformationsmatrix.transformPoint(ursprung), transformationsmatrix.transformDirection(normalisierteRichtung), 0.00001, Double.POSITIVE_INFINITY);
