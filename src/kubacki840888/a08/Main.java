...
public class Main {
    ...
    static String name = "doc/test14.png";
    ...
    static final Mat4 VORN = Mat4.translate(new Vec3(0, 0, 200));
    ...
    static final Mat4 OBEN = Mat4.translate(new Vec3(30, 180, -50)).mult(Mat4.rotate(10, 1, 0, -45));
    ...
    private static void listeAusfuellen(int anzahlKirbies, double abstandx) {
        ...
        shapes[3] =  new Group(spiegel, new Transform(Mat4.rotate(0,0,1,-45)));
