...
public class Main {
    ...
    static String name = "doc/test10.png";
    static final int WIDTH = 270;
    static final int HEIGHT = 270;
    static final Mat4 SCALE = Mat4.translate(0, 0, 0);
    ...
    static Kamera kamera = new Kamera(WIDTH, HEIGHT, Math.PI / 2, OBEN);
...
//    
    ...
    public static void main(String[] args) throws IOException {
        ...
        Group gruppe = new Group(shapes, new Transform(Mat4.scale(1, 1, 1)));
        Image image = SCENE.raytrace(kamera, gruppe, 3);
        image.write(name);
    }
